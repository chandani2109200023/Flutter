...
class _OrdersAgainPageState extends State<OrdersAgainPage> {
  ...
  Future<void> _getUserIdAndFetchOrders() async {
    ...
    if (userId != null && userId.isNotEmpty) {
      final String apiUrl = 'http://13.203.77.176:5000/api/payments/user/$userId';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(_isLoggedIn ? "Ordered Products" : "You May Like These Products"),
  leading: IconButton(
          ...
          actions: [
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  _createSlideTransitionRoute(const CartScreen()), // Add sliding effect here
                );
              },
              child: Center(
                child: badges.Badge(
                ...
                children: [
                  Positioned.fill(
                    child: Icon(
                      ...
                      size: 200,
                      color: Colors.green.withOpacity(0.2), // Optional color and opacity
                    ),
                  ),
                ],
              )
            : Container(
                ...
                child: errorMessage != null
                    ...
                    : ProductGrid(
                        ...
                        dbHelper: dbHelper, // Replace with actual dbHelper instance
