...
class _ReceiptDeliveryPageState extends State<ReceiptDeliveryPage> {
  ...
  Future<void> _fetchOrderDetails() async {
    final String orderApiUrl =
        'http://13.203.77.176:5000/api/delivery/order/${widget.orderId}';
  ...
  Future<void> _generateInvoice() async {
    ...
    final ByteData logoData = await rootBundle.load('assets/images/logo1.png');
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF92E3A9), Color(0xFF34B6B6)],
