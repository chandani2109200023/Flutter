  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        bool isWeb = maxWidth >= 1200; // Web if width is 1200 or more
        ...
        if (maxWidth < 600) {
          ...
          crossAxisSpacing = 12;
          childAspectRatio = 0.9; // Adjust aspect ratio for web (change as needed)
        }
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: ClipRect( // Clips overflowed content
                child: isWeb
                    ? ProductGridItemWeb(
