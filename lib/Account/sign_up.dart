...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> signupUser() async {
    ...
    if (name.isEmpty || email.isEmpty || phone.isEmpty || password.isEmpty) {
      setState(() {
        errorMessage = 'All fields are required. Please fill all fields.';
      });
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Color.fromARGB(255, 109, 240, 133), // Lighter green
                Color.fromARGB(255, 232, 240, 126), // Soft Yellow
              ],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height:
                        45), // Increased space between title and input fields
                TextField(
